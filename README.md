# Team Control (2026)
RoboCup SSL - Team TurtleRabbits - server 
...
```
git clone https://github.com/WSU-TurtleRabbit/2026-teamcontrol.git
./setup.sh
```

See [scripts/README.md](scripts/README.md) for Windows releases and other software packages on Linux.
